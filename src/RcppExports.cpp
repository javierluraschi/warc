...
RcppExport SEXP _warc_rcpp_read_warc(SEXP pathSEXP, SEXP filterSEXP, SEXP includeSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_warc_rcpp_read_warc", (DL_FUNC) &_warc_rcpp_read_warc, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_warc(DllInfo *dll) {
